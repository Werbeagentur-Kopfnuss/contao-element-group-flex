...
$GLOBALS['TL_LANG']['tl_content']['flexOptionsAlign'] = [
    ...
    'align-end' => 'Elemente unten platzieren',
];
$GLOBALS['TL_LANG']['tl_content']['flexOptionsJustify'] = [
    'justify-start' => 'Elemente linksbündig anordnen',
    'justify-center' => 'Elemente zentriert anordnen',
    'justify-end' => 'Elemente rechtsbündig anordnen',
    'justify-space-between' => 'Elemente mit gleichem Abstand anordnen',
];
